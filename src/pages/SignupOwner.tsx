...
import { User, Lock, Mail, Building2, Shield, ArrowLeft, Crown, FileText, CheckCircle2 } from "lucide-react";
...
const SignupOwner = () => {
  ...
  const getProgressPercentage = () => {
    const fields = ['passVerified', 'userId', 'password', 'passwordConfirm', 'email', 'businessLocation', 'businessNumber'];
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    if (!formData.userId || !formData.password || !formData.email || !formData.businessLocation || !formData.businessNumber) {
      toast({
        title: "필수 정보 입력",
        ...
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900 dark:text-white">사장님 회원가입</h1>
                <p className="text-sm text-gray-600 dark:text-gray-400">헬스장 운영을 시작해보세요</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="font-medium text-gray-900 dark:text-white">사업장 정보</h3>
                </div>
                ...
                <div className="grid gap-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="businessNumber" className="text-sm font-medium text-gray-700 dark:text-gray-300">사업자 번호 *</Label>
                    <Input
                      id="businessNumber"
                      ...
                      className="h-11 border-gray-300 dark:border-gray-600 focus:border-gray-900 dark:focus:border-gray-400 focus:ring-gray-900 dark:focus:ring-gray-400"
                    />
                    <p className="text-xs text-gray-500 dark:text-gray-400">사업자등록증에 있는 사업자번호를 입력해주세요</p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-8">
                <Button 
                  type="submit"
                  size="lg"
                  className="w-full h-12 font-medium bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white transition-colors"
                  disabled={isLoading}
                >
                  {isLoading ? (
